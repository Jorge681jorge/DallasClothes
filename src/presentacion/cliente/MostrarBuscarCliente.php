...
<script>
	...
	var url = "indexAjax.php?pid=<?php echo base64_encode("presentacion/cliente/MostrarBuscarClienteAjax.php")?>";
    $("#resultados").load(url);
...
$(document).ready(function(){ 
    ...
    $("#filtro").keyup(function() {
		if($(this).val().length >= 1){  	
				var url = "indexAjax.php?pid=<?php echo base64_encode("presentacion/cliente/MostrarBuscarClienteAjax.php")?>&filtro="+ $("#filtro").val();
    			$("#resultados").load(url);	
		}else{
			var url = "indexAjax.php?pid=<?php echo base64_encode("presentacion/cliente/MostrarBuscarClienteAjax.php")?>";
    		$("#resultados").load(url);
		...
		$("#cantidad").on("change", function() {
			var url = "indexAjax.php?pid=<?php echo base64_encode("presentacion/cliente/MostrarBuscarClienteAjax.php")?>&cantidad=" + $(this).val(); 	
			$("#resultados").load(url);
		});

		$("#paginaN").on("change",function() {
			if($(this).val()>= 1){
			var url = "indexAjax.php?pid=<?php echo base64_encode("presentacion/cliente/MostrarBuscarClienteAjax.php")?>&pagina=" + $(this).val()+"&cantidad=" + $(cantidad).val(); 	
			$("#resultados").load(url);
			}		
		});
